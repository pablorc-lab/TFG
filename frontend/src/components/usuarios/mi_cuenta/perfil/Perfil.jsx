...
const ContenidoGaleria = lazy(() => import("./PerfilValues").then(functions => ({ default: functions.ContenidoGaleria })));
  ...
  return (
    <>
      <article className={styles.miCuenta_title}>
        ...
        {!esViajero && showValue === 2 && <h1>Vivienda personal</h1>}
        {esViajero && showValue === 2 && <h1>Imágenes personales</h1>}
      ...
      {!esViajero && showValue === 2 && <ContenidoVivienda viviendaData={usuarioData.usuario.vivienda} />}
      {esViajero && showValue === 2 && <ContenidoGaleria galeriaData={usuarioData.usuario} />}
    </>
  );
}
