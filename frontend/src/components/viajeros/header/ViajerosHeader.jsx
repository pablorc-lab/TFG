      ...
      <section className={styles.search_container}>
        ...
        <article className={`${styles.search_form_container} ${activeSection !== "alojamientos" ? styles.inactive_form : undefined}`}>
          <form className={styles.search_form}>
            ...
            />
            {headerStates.locationFocus && headerStates.location && <FilteredCitiesList filteredCitiesListRef={filteredCitiesListRef} listStates={headerStates} updateListStates={updateHeaderStates} />}
          </form>
